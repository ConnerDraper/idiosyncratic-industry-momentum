Experimenting with idiosyncratic industry momentum.
...
Then we backtest using a rolling t-252 to t-21 idiosyncratic industry momentum signal.
One signal is scaled by idiosyncratic industry risk, and one is not.
